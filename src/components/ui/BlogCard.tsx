...
export default function BlogCard({ post }: Props) {
  return (
    <Link
      to={`/blog/${post.id}`}
      className="block py-6 border-b border-gray-100 last:border-0 group"
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-gray-400 group-hover:text-gray-900 transition-colors whitespace-nowrap">
          Read more →
        </span>
      </div>
    </Link>
